...
namespace PLAYER
{
	...
	static BOOL GET_ENTITY_PLAYER_IS_FREE_AIMING_AT(Player player, Entity* entity) { return invoke<BOOL>(0x2975C866E6713290, player, entity); } // 0x2975C866E6713290 0x8866D9D0  // took off ***
...
namespace VEHICLE
{
	...
	static int GET_VEHICLE_XENON_COLOUR(Vehicle vehicle) { return invoke<int>(0x3DFF319A831E0CDB, vehicle); } // 0x3DFF319A831E0CDB since b1604
	static void SET_HEADLIGHT_COLOR(Vehicle vehicle, int value) { invoke<Void>(0xE41033B25D003A07, vehicle, value); } // 0xE41033B25D003A07 since b1604
	static int GET_HEADLIGHT_COLOR(Vehicle vehicle) { return invoke<int>(0x3DFF319A831E0CDB, vehicle); } // 0x3DFF319A831E0CDB since b1604
...
namespace WEAPON
{
	...
	static BOOL GET_PED_LAST_WEAPON_IMPACT_COORD(Ped ped, Vector3* coords) { return invoke<BOOL>(0x6C4D0409BA1A2BC2, ped, coords); } // 0x6C4D0409BA1A2BC2 0x9B266079        //chnages fromv*
